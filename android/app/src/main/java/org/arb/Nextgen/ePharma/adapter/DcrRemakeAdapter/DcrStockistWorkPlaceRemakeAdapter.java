...
public class DcrStockistWorkPlaceRemakeAdapter extends RecyclerView.Adapter<DcrStockistWorkPlaceRemakeAdapter.MyViewHolder>{
    ...
    public DcrStockistWorkPlaceRemakeAdapter(Context ctx, ArrayList<DcrDctrChemistStockistWorkPlaceModel> dcrDctrChemistStockistWorkPlaceModelArrayList){

        inflater = LayoutInflater.from(ctx);
        this.dcrDctrChemistStockistWorkPlaceModelArrayList = dcrDctrChemistStockistWorkPlaceModelArrayList;
    }
    @Override
    public DcrStockistWorkPlaceRemakeAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = inflater.inflate(R.layout.recycler_dcr_dctr_chemist_stockist_workdplace_row, parent, false);
        DcrStockistWorkPlaceRemakeAdapter.MyViewHolder holder = new DcrStockistWorkPlaceRemakeAdapter.MyViewHolder(view);
        context = parent.getContext();
        return holder;
    }

    @Override
    public void onBindViewHolder(DcrStockistWorkPlaceRemakeAdapter.MyViewHolder holder, final int position) {
