...
public class DcrSelectDoctorRemakeAdapter extends RecyclerView.Adapter<DcrSelectDoctorRemakeAdapter.MyViewHolder>{
    ...
    public DcrSelectDoctorRemakeAdapter(Context ctx, ArrayList<DcrSelectDoctorStockistChemistModel> dcrSelectDoctorStockistChemistModelArrayList){

        inflater = LayoutInflater.from(ctx);
        this.dcrSelectDoctorStockistChemistModelArrayList = dcrSelectDoctorStockistChemistModelArrayList;
    }
    @Override
    public DcrSelectDoctorRemakeAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = inflater.inflate(R.layout.recycler_dcr_dctr_chemist_stockist_workdplace_row, parent, false);
        DcrSelectDoctorRemakeAdapter.MyViewHolder holder = new DcrSelectDoctorRemakeAdapter.MyViewHolder(view);
        context = parent.getContext();
        return holder;
    }

    @Override
    public void onBindViewHolder(DcrSelectDoctorRemakeAdapter.MyViewHolder holder, final int position) {
