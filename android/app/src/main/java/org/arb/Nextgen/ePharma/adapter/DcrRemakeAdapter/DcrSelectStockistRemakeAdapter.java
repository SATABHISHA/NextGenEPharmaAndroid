...
public class DcrSelectStockistRemakeAdapter extends RecyclerView.Adapter<DcrSelectStockistRemakeAdapter.MyViewHolder>{
    ...
    public DcrSelectStockistRemakeAdapter(Context ctx, ArrayList<DcrSelectDoctorStockistChemistModel> dcrSelectDoctorStockistChemistModelArrayList){

        inflater = LayoutInflater.from(ctx);
        this.dcrSelectDoctorStockistChemistModelArrayList = dcrSelectDoctorStockistChemistModelArrayList;
    }
    @Override
    public DcrSelectStockistRemakeAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = inflater.inflate(R.layout.recycler_dcr_dctr_chemist_stockist_workdplace_row, parent, false);
        DcrSelectStockistRemakeAdapter.MyViewHolder holder = new DcrSelectStockistRemakeAdapter.MyViewHolder(view);
        context = parent.getContext();
        return holder;
    }

    @Override
    public void onBindViewHolder(DcrSelectStockistRemakeAdapter.MyViewHolder holder, final int position) {
