...
public class DcrSelectDoctorAdapter extends RecyclerView.Adapter<DcrSelectDoctorAdapter.MyViewHolder>{
    ...
    public DcrSelectDoctorAdapter(Context ctx, ArrayList<DcrSelectDoctorStockistChemistModel> dcrSelectDoctorStockistChemistModelArrayList){

        inflater = LayoutInflater.from(ctx);
        this.dcrSelectDoctorStockistChemistModelArrayList = dcrSelectDoctorStockistChemistModelArrayList;
    }
    @Override
    public DcrSelectDoctorAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = inflater.inflate(R.layout.recycler_dcr_dctr_chemist_stockist_workdplace_row, parent, false);
        DcrSelectDoctorAdapter.MyViewHolder holder = new DcrSelectDoctorAdapter.MyViewHolder(view);
        context = parent.getContext();
        return holder;
    }

    @Override
    public void onBindViewHolder(DcrSelectDoctorAdapter.MyViewHolder holder, final int position) {
