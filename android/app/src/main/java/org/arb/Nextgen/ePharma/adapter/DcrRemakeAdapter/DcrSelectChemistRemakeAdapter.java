...
public class DcrSelectChemistRemakeAdapter extends RecyclerView.Adapter<DcrSelectChemistRemakeAdapter.MyViewHolder>{
    ...
    public DcrSelectChemistRemakeAdapter(Context ctx, ArrayList<DcrSelectDoctorStockistChemistModel> dcrSelectDoctorStockistChemistModelArrayList){

        inflater = LayoutInflater.from(ctx);
        this.dcrSelectDoctorStockistChemistModelArrayList = dcrSelectDoctorStockistChemistModelArrayList;
    }
    @Override
    public DcrSelectChemistRemakeAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = inflater.inflate(R.layout.recycler_dcr_dctr_chemist_stockist_workdplace_row, parent, false);
        DcrSelectChemistRemakeAdapter.MyViewHolder holder = new DcrSelectChemistRemakeAdapter.MyViewHolder(view);
        context = parent.getContext();
        return holder;
    }

    @Override
    public void onBindViewHolder(DcrSelectChemistRemakeAdapter.MyViewHolder holder, final int position) {
