...
import static org.arb.Nextgen.ePharma.DcrAgainRemake.DcrViewChemistRemake.dcrViewChemistRemakeAdapter;

public class DcrViewChemistRemakeAdapter extends RecyclerView.Adapter<DcrViewChemistRemakeAdapter.MyViewHolder> {
...
//    public static TextView tv_download;
    ...
    public DcrViewChemistRemakeAdapter(Context ctx, ArrayList<DcrSelectDoctorStockistChemistModel> dcrSelectDoctorStockistChemistModelArrayList){

        inflater = LayoutInflater.from(ctx);
        this.dcrSelectDoctorStockistChemistModelArrayList = dcrSelectDoctorStockistChemistModelArrayList;
    }
    @Override
    public DcrViewChemistRemakeAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = inflater.inflate(R.layout.activity_dcr_view_doctor_remake_row, parent, false);
        DcrViewChemistRemakeAdapter.MyViewHolder holder = new DcrViewChemistRemakeAdapter.MyViewHolder(view);
        context = parent.getContext();
        return holder;
    }

    @Override
    public void onBindViewHolder(DcrViewChemistRemakeAdapter.MyViewHolder holder, int position) {
...
//                    TaskSelectionActivity.taskSelectionAdapter.notifyDataSetChanged();
                   ...
                   /* DcrTypeRemakeActivity.dcr_id = dcrTypeModelArrayList.get(position).getId();
                    ...
                    dcrViewChemistRemakeAdapter.notifyItemRemoved(position);
