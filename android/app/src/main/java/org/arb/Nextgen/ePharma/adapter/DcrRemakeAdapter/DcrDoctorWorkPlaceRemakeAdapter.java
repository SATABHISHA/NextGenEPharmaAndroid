...
public class DcrDoctorWorkPlaceRemakeAdapter extends RecyclerView.Adapter<DcrDoctorWorkPlaceRemakeAdapter.MyViewHolder>{
    ...
    public DcrDoctorWorkPlaceRemakeAdapter(Context ctx, ArrayList<DcrDctrChemistStockistWorkPlaceModel> dcrDctrChemistStockistWorkPlaceModelArrayList){

        inflater = LayoutInflater.from(ctx);
        this.dcrDctrChemistStockistWorkPlaceModelArrayList = dcrDctrChemistStockistWorkPlaceModelArrayList;
    }
    @Override
    public DcrDoctorWorkPlaceRemakeAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = inflater.inflate(R.layout.recycler_dcr_dctr_chemist_stockist_workdplace_row, parent, false);
        DcrDoctorWorkPlaceRemakeAdapter.MyViewHolder holder = new DcrDoctorWorkPlaceRemakeAdapter.MyViewHolder(view);
        context = parent.getContext();
        return holder;
    }

    @Override
    public void onBindViewHolder(DcrDoctorWorkPlaceRemakeAdapter.MyViewHolder holder, final int position) {
