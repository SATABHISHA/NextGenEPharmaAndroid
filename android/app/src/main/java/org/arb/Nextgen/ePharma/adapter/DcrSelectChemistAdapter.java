...
public class DcrSelectChemistAdapter extends RecyclerView.Adapter<DcrSelectChemistAdapter.MyViewHolder>{
    ...
    public DcrSelectChemistAdapter(Context ctx, ArrayList<DcrSelectDoctorStockistChemistModel> dcrSelectDoctorStockistChemistModelArrayList){

        inflater = LayoutInflater.from(ctx);
        this.dcrSelectDoctorStockistChemistModelArrayList = dcrSelectDoctorStockistChemistModelArrayList;
    }
    @Override
    public DcrSelectChemistAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = inflater.inflate(R.layout.recycler_dcr_dctr_chemist_stockist_workdplace_row, parent, false);
        DcrSelectChemistAdapter.MyViewHolder holder = new DcrSelectChemistAdapter.MyViewHolder(view);
        context = parent.getContext();
        return holder;
    }

    @Override
    public void onBindViewHolder(DcrSelectChemistAdapter.MyViewHolder holder, final int position) {
