...
public class DcrChemistWorkPlaceAdapter extends RecyclerView.Adapter<DcrChemistWorkPlaceAdapter.MyViewHolder>{
    ...
    public DcrChemistWorkPlaceAdapter(Context ctx, ArrayList<DcrDctrChemistStockistWorkPlaceModel> dcrDctrChemistStockistWorkPlaceModelArrayList){

        inflater = LayoutInflater.from(ctx);
        this.dcrDctrChemistStockistWorkPlaceModelArrayList = dcrDctrChemistStockistWorkPlaceModelArrayList;
    }
    @Override
    public DcrChemistWorkPlaceAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = inflater.inflate(R.layout.recycler_dcr_dctr_chemist_stockist_workdplace_row, parent, false);
        DcrChemistWorkPlaceAdapter.MyViewHolder holder = new DcrChemistWorkPlaceAdapter.MyViewHolder(view);
        context = parent.getContext();
        return holder;
    }

    @Override
    public void onBindViewHolder(DcrChemistWorkPlaceAdapter.MyViewHolder holder, final int position) {
