...
import static org.arb.Nextgen.ePharma.DcrAgainRemake.DcrViewStockistRemakeActivity.dcrViewStockistRemakeAdapter;


public class DcrViewStockistRemakeAdapter extends RecyclerView.Adapter<DcrViewStockistRemakeAdapter.MyViewHolder> {
...
//    public static TextView tv_download;
    ...
    public DcrViewStockistRemakeAdapter(Context ctx, ArrayList<DcrSelectDoctorStockistChemistModel> dcrSelectDoctorStockistChemistModelArrayList){

        inflater = LayoutInflater.from(ctx);
        this.dcrSelectDoctorStockistChemistModelArrayList = dcrSelectDoctorStockistChemistModelArrayList;
    }
    @Override
    public DcrViewStockistRemakeAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = inflater.inflate(R.layout.activity_dcr_view_doctor_remake_row, parent, false);
        DcrViewStockistRemakeAdapter.MyViewHolder holder = new DcrViewStockistRemakeAdapter.MyViewHolder(view);
        context = parent.getContext();
        return holder;
    }

    @Override
    public void onBindViewHolder(DcrViewStockistRemakeAdapter.MyViewHolder holder, int position) {
...
//                    TaskSelectionActivity.taskSelectionAdapter.notifyDataSetChanged();
                   ...
                   /* DcrTypeRemakeActivity.dcr_id = dcrTypeModelArrayList.get(position).getId();
                    ...
                    dcrViewStockistRemakeAdapter.notifyItemRemoved(position);
