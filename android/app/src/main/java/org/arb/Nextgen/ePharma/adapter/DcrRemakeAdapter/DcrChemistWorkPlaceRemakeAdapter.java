...
public class DcrChemistWorkPlaceRemakeAdapter extends RecyclerView.Adapter<DcrChemistWorkPlaceRemakeAdapter.MyViewHolder>{
    ...
    public DcrChemistWorkPlaceRemakeAdapter(Context ctx, ArrayList<DcrDctrChemistStockistWorkPlaceModel> dcrDctrChemistStockistWorkPlaceModelArrayList){

        inflater = LayoutInflater.from(ctx);
        this.dcrDctrChemistStockistWorkPlaceModelArrayList = dcrDctrChemistStockistWorkPlaceModelArrayList;
    }
    @Override
    public DcrChemistWorkPlaceRemakeAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = inflater.inflate(R.layout.recycler_dcr_dctr_chemist_stockist_workdplace_row, parent, false);
        DcrChemistWorkPlaceRemakeAdapter.MyViewHolder holder = new DcrChemistWorkPlaceRemakeAdapter.MyViewHolder(view);
        context = parent.getContext();
        return holder;
    }

    @Override
    public void onBindViewHolder(DcrChemistWorkPlaceRemakeAdapter.MyViewHolder holder, final int position) {
