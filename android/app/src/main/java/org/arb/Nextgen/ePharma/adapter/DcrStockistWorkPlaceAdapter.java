...
public class DcrStockistWorkPlaceAdapter extends RecyclerView.Adapter<DcrStockistWorkPlaceAdapter.MyViewHolder>{
    ...
    public DcrStockistWorkPlaceAdapter(Context ctx, ArrayList<DcrDctrChemistStockistWorkPlaceModel> dcrDctrChemistStockistWorkPlaceModelArrayList){

        inflater = LayoutInflater.from(ctx);
        this.dcrDctrChemistStockistWorkPlaceModelArrayList = dcrDctrChemistStockistWorkPlaceModelArrayList;
    }
    @Override
    public DcrStockistWorkPlaceAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = inflater.inflate(R.layout.recycler_dcr_dctr_chemist_stockist_workdplace_row, parent, false);
        DcrStockistWorkPlaceAdapter.MyViewHolder holder = new DcrStockistWorkPlaceAdapter.MyViewHolder(view);
        context = parent.getContext();
        return holder;
    }

    @Override
    public void onBindViewHolder(DcrStockistWorkPlaceAdapter.MyViewHolder holder, final int position) {
